...
class AuctionItem {
	...
	protected AuctionItem(double buyItNow, String title, BigDecimal timer, double bidCurrent, String desc,
			String bidMessage, double reserve, String highestBidder) {
